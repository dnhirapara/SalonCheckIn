...
const CustomerProfile = () =>{
    ...
    <div className="row">
      ...
      <img src='images/chair.jpg' className="align-self-center img-fluid rounded" alt="..."/>
      </div>
      ...
      <div className="col-md-6 mycol col-sm-12" style={mycol}>
       ...
       <span className="text-light text-capitalize ">221B Baker Street</span>
       <p className="text-muted text-capitalize">email:</p>
       <span className="text-light text-capitalize ">watson@gmail.com</span>
