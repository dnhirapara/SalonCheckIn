...
const CustomerSalon = () => {
    ...
    <div className="row">
      ...
      <div className="col-md-6 mycol col-sm-12" style={mycol}>
       ...
       <p className="text-light text-capitalize ">Appointments Left:<span className="text-danger">&nbsp;2</span></p>
      ...
      <div className="col-md-3 mycol col-sm-12" style={mycol}>
       ...
       <p className="text-light text-capitalize ">Grab 5% Disccount on Corean Cut</p>
  ...
  <div className="col-md-5 p-2" style={styles}>
     ...
     <ul class="list-group">
      ...
      <a href="/appointment" className="btn btn-secondary btn-sm active center" role="button" aria-pressed="true">Make an Appointment</a>
     ...
     <hr className="w-25 mx-auto pt-2"/>
     <ul class="list-group">
        <li class="list-group-item centered">Corean Cut</li>
        <li class="list-group-item">Hair Cut</li>
        <li class="list-group-item">Special Hair Cut</li>
        <li class="list-group-item">Sherlock's Cut</li>
      </ul>
     </div>
      {/* <Divider orientation="vertical" flexItem />
      <div className="col-md-2 p-2" style={styles}>
